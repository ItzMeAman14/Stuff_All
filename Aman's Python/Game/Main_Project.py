...
def TTT():
    ...
    b = Button(win, text = "Restart Game", command=restart)
    b.place(x = 300, y = 350)

    b1 = Button(win, text = "Exit", command=exit)
    b1.place(x = 100, y = 350)

    Xlabel = Label(win, text = "X Score:" + str(xscore), font = ('Garamond', 25), underline=0)
    Xlabel.place(x = 50 , y = 400)

    labchance = Label(win, text = "X's Turn", font = ("Garamond", 25), underline=0)
    labchance.place(x = 190, y = 298)

    Olabel = Label(win, text='O Score:' + str(oscore), font = ("Garamond", 25), underline=0)
